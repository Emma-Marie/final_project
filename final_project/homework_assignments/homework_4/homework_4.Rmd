...
How clean and analysis-ready is the dataset? Do you understand what the column names represent? What is the difference between rate and homicide number?
  ...
  __My answer__
After inspecting the data set I find it was almost analysis-ready and the  column names understandable except understandable except from the column name  `Homicide rate in Europe over long-term (per 100,000)`which I change in the next task. 
...
Ok, the data look good except for  which is not very easy to work with.
...
```
Now the data is ready for vizualisation: 

```{r creating kings chart, eval = TRUE}
