...
I will create a data frame only containing the funerals in the national church the sum of those. This means I will only choose the first four rows from the `funerals_clean` data for this data set. 
